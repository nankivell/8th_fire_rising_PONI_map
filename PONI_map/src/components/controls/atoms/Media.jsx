  ...
  switch (type) {
    ...
    case "Telegram":
      if (src.includes("https://t.me/c/")) {
        return <div>Private <a href={src} target="_blank" rel="noopener noreferrer">telegram post</a></div>
      }
      try {
        return wrapGraphic(
        ...
        return <div>Unable to display <a href={src} target="_blank" rel="noopener noreferrer">telegram post</a></div>
      }
    ...
    case "Tweet":
      ...
      try {
        ...
        return <div>Unable to display <a href={src} target="_blank" rel="noopener noreferrer">tweet</a></div>
      }
      ...
      return wrapGraphic(
        <div className="card-cell media">
          ...
          <div className="link-preview">
            ...
            <iframe src={src} title={title || src} />
          </div>
        </div>
      );
   default:
